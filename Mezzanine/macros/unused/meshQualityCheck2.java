...
public class meshQualityCheck2 extends StarMacro {
    ...
    public void execute() {
        ...
        sim.println("==============================================");
        sim.println("Fluid cells: " + fluidCellCount);
        output.add("Fluid cells: " + fluidCellCount);
        if (solids) {
            sim.println("Solid cells: " + solidCellCount);
            output.add("Solid cells: " + solidCellCount);
        }
    ...
    private void deleteOldSession(Simulation sim) {
        ...
        //parts
        ArrayList<String> partNames = new ArrayList<String>(Arrays.asList("cellQualityFluid", "skewnessFluid", "volumeChangeFluid", "volume", "cellQualitySolid", "skewnessSolid", "volumeChangeSolid", "prisms", "badCellsSolid", "badCellsFluid", "XYsection", "XZsection", "YZsection", "XYsurface", "XZsurface", "YZsurface"));
    ...
    private Boolean createCellQualityMetric(Simulation sim, double cellQualityThreshold, double fluidCellCount, double solidCellCount, Boolean solids) {
        ...
        sim.println(
                "Fluid cells below quality " + cellQualityThreshold + ": " + cqRf.getReportMonitorValue() + " " + String.format("%.2f", (cqRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        output.add("Fluid cells below quality " + cellQualityThreshold + ": " + cqRf.getReportMonitorValue() + " " + String.format("%.2f", (cqRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        ...
        if (solids) {
            ...
            sim.println("Solid cells below quality " + cellQualityThreshold + ": " + cqRs.getReportMonitorValue() + " " + String.format("%.2f", (cqRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
            output.add("Solid cells below quality " + cellQualityThreshold + ": " + cqRs.getReportMonitorValue() + " " + String.format("%.2f", (cqRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
        }
        return solids;
    }
    ...
    private void createSkewnessMetric(Simulation sim, double skewnessThreshold, double fluidCellCount, double solidCellCount, Boolean solids) {
        ...
        sim.println("Fluid cells above skewness angle " + skewnessThreshold + ": " + skRf.getReportMonitorValue() + " " + String.format("%.2f", (skRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        //if solid regions exist, also do it on solids
        ...
        if (solids) {
            ...
            sim.println("Solid cells above skewness angle " + skewnessThreshold + ": " + skRs.getReportMonitorValue() + " " + String.format("%.2f", (skRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
            output.add("Solid cells above skewness angle " + skewnessThreshold + ": " + skRs.getReportMonitorValue() + " " + String.format("%.2f", (skRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
        }
    }
    ...
    private void volChangeMetric(Simulation sim, double volumeChangeThreshold, double fluidCellCount, double solidCellCount, Boolean solids) {
        ...
        sim.println(
                "Fluid cells below volume change " + volumeChangeThreshold + ": " + vcRf.getReportMonitorValue() + " " + String.format("%.2f", (vcRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        //if solid regions exist, also do it on solids
        output.add("Fluid cells below volume change " + volumeChangeThreshold + ": " + vcRf.getReportMonitorValue() + " " + String.format("%.2f", (vcRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        ...
        if (solids) {
            ...
            sim.println("Solid cells below volume change " + volumeChangeThreshold + ": " + vcRs.getReportMonitorValue() + " " + String.format("%.2f", (vcRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
            output.add("Solid cells below volume change " + volumeChangeThreshold + ": " + vcRs.getReportMonitorValue() + " " + String.format("%.2f", (vcRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
        }
    }
    ...
    private void negVolCellCount(Simulation sim) {
        ...
        sim.println("Cells with negative volume: " + cellVolume.getReportMonitorValue());
        output.add("Cells with negative volume: " + cellVolume.getReportMonitorValue());
    }
    ...
    private void maxSkewnessMetric(Simulation sim) {
        ...
        sim.println("Maximum skewness angle: " + String.format("%.2f", (mSR.getReportMonitorValue())));
        sim.getReportManager().getGroupsManager().getObject("cellQualityReports").addObjects(new NeoObjectVector(new Object[]{mSR}));
        output.add("Maximum skewness angle: " + String.format("%.2f", (mSR.getReportMonitorValue())));
    }
    ...
    private void minCellQualityMetric(Simulation sim) {
        ...
        sim.println("Minimum cell quality: " + String.format("%.5f", (mCQ.getReportMonitorValue())));
        output.add("Minimum cell quality: " + String.format("%.5f", (mCQ.getReportMonitorValue())));
    ...
    private void badCellIndicatorMetric(Simulation sim, double fluidCellCount, double solidCellCount, Boolean solids) {
        ...
        sim.println(
                "Fluid cells marked bad: " + bcRf.getReportMonitorValue() + " " + String.format("%.2f", (bcRf.getReportMonitorValue() / fluidCellCount * 100)) + "%");
        //if solid regions exist, also do it on solids
        ...
        if (solids) {
            ...
            sim.println("Solid cells marked bad: " + bcRs.getReportMonitorValue() + " " + String.format("%.2f", (bcRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
            output.add("Solid cells marked bad: " + bcRs.getReportMonitorValue() + " " + String.format("%.2f", (bcRs.getReportMonitorValue() / solidCellCount * 100)) + "%");
        }
    }
...
//        }
        ...
        XYsection.setPresentationName("XYsection");
        XZsection.setPresentationName("XZsection");
        YZsection.setPresentationName("YZsection");
        ...
        XYcellSurface.setPresentationName("XYsurface");
        XZcellSurface.setPresentationName("XZsurface");
        YZcellSurface.setPresentationName("YZsurface");
