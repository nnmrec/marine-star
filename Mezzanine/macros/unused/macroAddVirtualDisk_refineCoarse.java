// STAR-CCM+ macro: macroAddVirtualDisk_refineCoarse.java
...
public class macroAddVirtualDisk_refineCoarse extends StarMacro {
...
// 		// dunno why but these things behave better in a separate loop
    ...
    // 			volumeAverageReport_0.setRepresentation(fvRepresentation_0);
		...
		// the "Volume Mesh" representation has not been created yet
		// for (int i = 0; i < nVirtualDisks; i++) {
		...
		//       	FvRepresentation fvRepresentation_0 = 
  //     			  ((FvRepresentation) simulation_0.getRepresentationManager().getObject("Volume Meshz"));
